...
<head>
    ...
    <title>Explaining Strategy - Terms & Conditions</title>
...
<body>
    <div class="pt-4 bg-gray-100 dark:bg-gray-900">
        <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
            ...
            <div class="w-full sm:max-w-2xl mt-6 p-6 bg-[#F2F0FE] dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg prose dark:prose-invert">
                <h1 class="subtitle font-thin">Terms and Conditions</h1>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Strategsys LLC, 300 Delaware Ave, Ste 210 #580.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Explaining Strategy, accessible from <a href="https://explaining-strategy.com" rel="external nofollow noopener" target="_blank">https://explaining-strategy.com</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: info [@] strategsys.com</li>
                </ul>
            </div>
        </div>
    </div>
